    ...
    <Grid className="repo-page">
      <Column lg={16} className="repo-page__r1">
        ...
        <Pagination
          ...
          // currentPage size and FirstRowIndex are together controoling
          // what id displayed .
          onChange={({ page, pageSize }) => {
            if (pageSize !== currentPageSize) {
              setCurrentPageSize(pageSize);
            }
            setFirstRowIndex(pageSize * (page - 1)); // for page 2 , staring index is 5*(2-1) = 5
            // for page 1 , starting index is 5(1-1) =0 .. so on
            // ie index = pagesize * ( pg_no - 1)
          }}
        />
      </Column>
    </Grid>
